 ...
 * @author liuxu11
 * @describe:
 * @date on 2021/4/1 14:46
 **/
public class FaceCaptureFragment extends BaseFragment {

    private FaceCaptureViewModel mState;

    @Override
    protected void initViewModel() {
        mState = getFragmentScopeViewModel(FaceCaptureViewModel.class);
    }

    @Override
    protected DataBindingConfig getDataBindingConfig() {
        return new DataBindingConfig(R.layout.fragment_face_capture, BR.vm, mState);
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //设置采集预处理
        mState.setEnrollMode(AuthModeType.enroll, EnrollModeType.face);
