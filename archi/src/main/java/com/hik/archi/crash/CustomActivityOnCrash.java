...
public final class CustomActivityOnCrash {
    ...
    public static String getStackTraceFromIntent(@NonNull Intent intent) {
        return Objects.requireNonNull(intent.getStringExtra(CustomActivityOnCrash.EXTRA_STACK_TRACE));
    }
    ...
    public static CaocConfig getConfigFromIntent(@NonNull Intent intent) {
        return (CaocConfig) Objects.requireNonNull(intent.getSerializableExtra(CustomActivityOnCrash.EXTRA_CONFIG));
    }
    ...
    private static Class<? extends Activity> getLauncherActivity(@NonNull Context context) {
        ...
        if (intent != null) {
            try {
                return (Class<? extends Activity>) Class.forName(Objects.requireNonNull(intent.getComponent()).getClassName());
            } catch (ClassNotFoundException e) {
                //Should not happen, print it to the log!
