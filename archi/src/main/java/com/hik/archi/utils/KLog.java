...
import com.hik.archi.utils.klog.BaseLog;
import com.hik.archi.utils.klog.FileLog;
import com.hik.archi.utils.klog.JsonLog;
import com.hik.archi.utils.klog.XmlLog;
...
public final class KLog {
    ...
    private static void printStackTrace() {
        ...
        for (String trace : traceString) {
            if (trace.contains("at com.odis.global.utils.KLog")) {
                continue;
            }
